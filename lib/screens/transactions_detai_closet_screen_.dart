...
class TransactionsDetailClosetScreen extends StatefulWidget {
  ...
  const TransactionsDetailClosetScreen({
    Key? key,
  ...
  @override
  _TransactionsDetailClosetScreenState createState() => _TransactionsDetailClosetScreenState();
}

class _TransactionsDetailClosetScreenState extends State<TransactionsDetailClosetScreen> {
  ...
  void initState() {
    ...
    TransactionsProvider().getTransactionsClosetLot(context, widget.merchant, widget.terminal, widget.lote)
        .then((transactions) {
      setState(() {
